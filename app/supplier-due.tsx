...
export default function SupplierDueScreen() {
  ...
  const filtered = all.filter((r) => {
    if (!(r.type === "payment" && r.paymentType === "due")) return false;
  ...
  const supplierCount = filtered.length;
      ...
      <View style={styles.content}>
        ...
        <Card mode="elevated" style={styles.summaryCard}>
          <Card.Content style={styles.summaryRow}>
            <View>
              <Text variant="labelMedium">Outstanding supplier dues</Text>
              <Text variant="headlineSmall" style={styles.summaryAmount}>
                ৳ {totalDue.toLocaleString()}
              </Text>
            </View>
            <View style={styles.summaryMeta}>
              <Text variant="labelMedium">{supplierCount}</Text>
              <Text variant="bodySmall">suppliers</Text>
            </View>
          </Card.Content>
        </Card>
        <TransactionsList
          title="Supplier due records"
          records={filtered}
